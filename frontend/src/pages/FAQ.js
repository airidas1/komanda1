        ...
        <div className={styles.container}>
          ...
          <div className={styles.questions}>
            <Collapse defaultActiveKey={["1"]} className={styles.question}>
              ...
              >
                <p>
                  Tikriausiai skiriasi laisvumu, kur dėmesys nukreiptas į
                  procesą, o ne į rezultatus. Formalusis daugiau turi
                  apribojimų, nuostatų ir taisyklių. Neformalusis daug
                  laisvesnis, labiau linkęs į asmenybės ugdymą. Šiandien
                  takoskyra yra vis mažėjanti ir daug neformaliojo ugdymo metodų
                  ir patirčių perkeliama į formalųjį ugdymą ir atvirkščiai, vis
                  labiau tampa vadinamu “visuminiu” ugdymu. Tik vis dar
                  Lietuvoje dažnai suvokiamas neformalusis kaip sporto ar
                  muzikos būrelių rėmuose, o tai yra žymiai plačiau.
                </p>
              </Panel>
              <Panel
              ...
              >
                <p>
                  ...
                  Tave įvertina ne tik vadinami klientai, mokymo dalyviai, bet
                  ir ekspertai, srities profesionalai.
                </p>
              </Panel>
              <Panel
              ...
              >
                <p>
                  Tai priklauso nuo situacijos, dažnu atveju priklauso nuo to
                  kiek infrastruktūros ir pedagogų bei kokio lygio reikia jų
                  reikia. Tad vieno tikslaus atsakymo nėra, tačiau formalusis
                  dažnai reikalauja daugiau išteklių ir pasiruošimo.
                </p>
              </Panel>
              <Panel
              ...
              >
                <p>
                  ...
                  su kitomis formaliomis programomis, suteikiama papildoma
                  pagalba iš valstybės, didesnės galimybės gauti papildomų
                  išteklių veiklos vykdymui ir pan.
                </p>
              </Panel>
              <Panel
              ...
              >
                <p>
                  ...
                  užsienyje, todėl tikrai pravers keičiant profesiją ar
                  tobulėjant savo profesiniame kelyje. Taip pat baigus
                  formaliuosius mokymus gaunami oficialūs kreditai, kurie yra
                  sudaryti atsižvelgiant į Europos profesinio mokymo kreditų
                  sistemą, ir gali praversti stojant į aukštąsias mokyklas.
                </p>
              </Panel>
              <Panel
              ...
              >
                <p>
                  ...
                  pretenduoti į valstybės finansuojamą studijų vietą. Tokiu
                  atveju studentas nemoka už studijas. Asmenys, kurie
                  geriausiais rezultatais baigė bendrojo ugdymo mokyklą ir nori
                  mokytis nevalstybinėje aukštojoje mokykloje, gali gauti
                  valstybės studijų stipendiją.
                </p>
              </Panel>
            </Collapse>
          </div>
