          ...
          <div className={styles.about_us}>
            <div className={styles.headline}>
              ...
              <p>
                ...
                naudojame "Express" - „Node.js“ internetinės programos
                pagrindas, išleistas kaip nemokama ir atviro kodo programinė
                įranga pagal MIT licenciją, bei „MongoDB“ - prieinama šaltinio
                duomenų bazių programa, orientuota į įvairias platformas.
                Klasifikuojamas kaip NoSQL duomenų bazės programa, „MongoDB“
                naudoja į JSON panašius dokumentus su pasirinktinėmis schemomis.
              </p>
            </div>
          ...
          <div className={styles.responses}>
            ...
            <div className={styles.response}>
              <p>
                ...
                dalykinį, sociokultūrinį, technologinį raštingumą; dorinę,
                tautinę ir pilietinę brandą; profesinės kompetencijos pradmenis.
                "
              </p>
            </div>
            <div className={styles.response}>
              <p>
                ...
                pasirinkusiam asmeniui. Asmuo turi būti ne jaunesnis kaip 18
                metų. Neformalųjį suaugusiųjų švietimą gali teikti visi švietimo
                teikėjai. "
              </p>
            </div>
          </div>
