...
let AdminPanel = () => {
  ...
  const deletePostHandler = (id) => {
    axios
      .delete('http://localhost:3001/v1/data', {
        headers: {
          'admin-id': localStorage.getItem('admin-id'),
        },
        data: {
  ...
  const updateHandler = (e, body) => {
    e.preventDefault();
    axios
      .put('http://localhost:3001/v1/dataUpdate', body, {
        headers: {
          'admin-id': localStorage.getItem('admin-id'),
        },
      })
  ...
  const passwordHandler = (e, body) => {
    e.preventDefault();
    axios
      .post('http://localhost:3001/v1/admin/update', body, {
        headers: {
          'admin-id': localStorage.getItem('admin-id'),
        ...
        <div className={styles['header-container']}>
          <ul className={`${styles['navbar']}`}>
            ...
            <li>
              <Link
                to='/v1/admin/howto'
                className={`${styles['header-btn']} ${styles['Link']}`}
              >
                How To
              </Link>
            </li>
              ...
              <form className={styles['update-button-form']}>
                ...
                <div className={styles['form-control']}>
                  ...
                  <input
                    className={styles['form-input']}
                    value={
                      updateModalData['Grupė'] ? updateModalData['Grupė'] : null
                    }
                    type='text'
                    list='update-gr'
                    onChange={(e) =>
                ...
                <div className={styles['form-control']}>
                  ...
                  <input
                    className={styles['form-input']}
                    value={
                      updateModalData['Pagrindinis tipas']
                        ? updateModalData['Pagrindinis tipas']
                        : null
                    }
                    type='text'
                ...
                <div className={styles['form-control']}>
                  <input
                    ...
                    type='submit'
                    value='Pateikti'
                    onClick={(e) => updateHandler(e, updateModalData)}
                  />
                </div>
              </form>
            </div>
            ...
            <div className={styles['modal-container']}>
              <form>
                <div className={styles['form-control']}>
                  <label
                    className={styles['form-label']}
                    htmlFor='update-pass1'
                  >
                    Iveskite Sena Slaptazodi
                  </label>
                  <input
                    className={styles['form-input']}
                    type='password'
                ...
                <div className={styles['form-control']}>
                  <label
                    className={styles['form-label']}
                    htmlFor='update-pass2'
                  >
                    Iveskite nauja slaptazodi
                  </label>
                  <input
                    className={styles['form-input']}
                    type='password'
                ...
                <input
                  ...
                  type='submit'
                  value='Pateikti'
                  onClick={(e) => passwordHandler(e, passwordData)}
                />
              </form>
            </div>
          </div>
                    ...
                    <div key={el._id} className={styles['output-item']}>
                      ...
                      <div className={styles['button-div']}>
                        <button
                          ...
                          onClick={() => deletePostHandler(el._id)}
                        >
                          Ištrinti
                        </button>
                        <button
