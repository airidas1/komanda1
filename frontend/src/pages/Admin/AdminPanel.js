            ...
            <main className={styles.main}>
                ...
                <div className={styles.wrapper}>
                    ...
                    <div className={styles.pagination}>
                        <button onClick={() => pageHandler('dec')} className={styles['pagination-button']}><FontAwesomeIcon className={styles['fontawesome-icon']} icon={['fas', 'chevron-left']} size='2x'/></button>
                        <div className={styles['input-pagination']}><input className={styles['input-txt']} type='number' placeholder={page} onKeyDown={pageInputHandler} /><h5 className={styles.pageCount}>/{Math.ceil(amount/20)}</h5></div>
                        <button onClick={() => pageHandler('inc')} className={styles['pagination-button']}><FontAwesomeIcon className={styles['fontawesome-icon']} icon={['fas', 'chevron-right']} size='2x'/></button>
